...
export const metadata = {
  title: 'Hubungi Kami',
  description: 'Hubungi layanan pelanggan ZAM Edutoys untuk pertanyaan atau informasi lebih lanjut.',
  openGraph: {
    title: 'Kontak | ZAM Edutoys',
    description: 'Hubungi kami sekarang untuk layanan pelanggan, pertaanyaan, maupun penawaran kerja sama.',
  }
};

export default function KontakPage() {
  const contactLinks = [
    { name: 'WhatsApp', value: '+62 899-5366-864', icon: 'fa-brands fa-whatsapp', color: '#25D366', href: 'https://wa.me/628995366864' },
